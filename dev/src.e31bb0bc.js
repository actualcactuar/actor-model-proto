...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"lib/router.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createRouter = exports.useTemplate = void 0;
...
var defineRouterLink = function defineRouterLink(navigate) {
  var RouterLink =
  /*#__PURE__*/
  function (_HTMLElement) {
    ...
    function RouterLink() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(RouterLink).call(this));

      _this.addEventListener('click', function (event) {
        event.preventDefault();

        var pathname = _this.getAttribute('href');

        var search = _this.getAttribute('search');
...
var useTemplate = function useTemplate(id) {
...
var createRouter = function createRouter(routes) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      onNavigationStart = _ref.onNavigationStart,
      onNavigationEnd = _ref.onNavigationEnd;
  ...
  var buildRouteRegex = function buildRouteRegex(route) {
    var formattedRoute = route.path.split('/').map(function (str) {
      if (str.match(':')) {
        return '(.[^\\/])*\\w+';
      }
    ...
    var regex = new RegExp("^".concat(formattedRoute, "$"));
    return _objectSpread({}, route, {
      regex: regex
    });
  };

  var buildRouteParams = function buildRouteParams(_ref2) {
    var route = _ref2.route,
        pathname = _ref2.pathname;
    var splitPath = pathname.split('/');
    var params = {};
    route.path.split('/').forEach(function (param, index) {
      if (param.match(':')) {
  ...
  var setLinksActive = function setLinksActive(_ref3) {
    ...
    var linksToActivate = document.querySelectorAll("router-link[href=\"".concat(pathname, "\"]"));
  ...
  var formattedRoutes = routes.map(buildRouteRegex);
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _route$resolve = route.resolve, resolve = _route$resolve === void 0 ?
              /*#__PURE__*/
              _asyncToGenerator(
              /*#__PURE__*/
            ...
            case 10:
              ...
              if (onNavigationEnd) {
                onNavigationEnd(_objectSpread({}, routerState, {
                  outlet: outlet
                }));
              }
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee3(_ref7) {
      var pathname, search, skipPush, route, fullPath, params;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              pathname = _ref7.pathname, search = _ref7.search, skipPush = _ref7.skipPush;
              routerState.isNavigating = true;

              if (onNavigationStart) {
                onNavigationStart(_objectSpread({}, routerState, {
                  outlet: outlet
                }));
              }

              route = formattedRoutes.find(function (_ref8) {
            ...
            case 11:
              render(_objectSpread({}, notFoundRoute, {
                path: fullPath
              }));
              setLinksActive({
                pathname: pathname
  ...
  window.addEventListener('popstate', function (_ref9) {
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(_ref2) {
    var fragment, result, params, outlet;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            fragment = _ref2.fragment, result = _ref2.result, params = _ref2.params, outlet = _ref2.outlet;
            console.log('render', {
              fragment: fragment,
              result: result,
              params: params,
...
},{"../lib/component":"lib/component.js"}],"routes/settings.js":[function(require,module,exports) {
"use strict";
...
var onRender = function onRender(_ref) {
  var fragment = _ref.fragment,
      result = _ref.result;
  var p = document.createElement('p');
  p.innerHTML = "Resolved response was: ".concat(result);
...
exports.fragment = fragment;
},{"../lib/component":"lib/component.js"}],"routes/profile.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onRender = exports.fragment = void 0;
...
exports.onRender = onRender;
},{"../lib/component":"lib/component.js"}],"routes/notFound.js":[function(require,module,exports) {
"use strict";
...
exports.fragment = fragment;
},{"../lib/component":"lib/component.js"}],"routes/posts.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  regeneratorRuntime.mark(function _callee2(_ref3) {
    var route, result, tpl, fragment;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            route = _ref3.fragment, result = _ref3.result;
...
exports.fragment = fragment;
},{"../lib/component":"lib/component.js"}],"routes/index.js":[function(require,module,exports) {
"use strict";
...
var notFound = _interopRequireWildcard(require("./notFound"));

exports.notFound = notFound;

var posts = _interopRequireWildcard(require("./posts"));
...
var routes = [_objectSpread({
  path: '/home'
}, _routes.home), _objectSpread({
  path: '/profile'
...
var onNavigationStart = function onNavigationStart(state) {
  container.classList.add('route-loading');
};

var onNavigationEnd = function onNavigationEnd(state) {
  container.classList.remove('route-loading');
};

var routerConfig = {
  notFound: _routes.notFound,
  onNavigationEnd: onNavigationEnd,
  onNavigationStart: onNavigationStart
};
var navigate = (0, _router.createRouter)(routes, routerConfig);
exports.navigate = navigate;
},{"./lib/router":"lib/router.js","./routes":"routes/index.js"}],"lib/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.wait = exports.generateToken = void 0;

var generateToken = function generateToken() {
  var tokenFragment = function tokenFragment(radix) {
    return Math.random().toString(radix).substr(2);
  };

  return "".concat(tokenFragment(12), "-").concat(tokenFragment(36), "-").concat(tokenFragment(22));
};
...
exports.wait = wait;
},{}],"lib/asyncWorker.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.workerMessageHandler = exports.AsyncWorker = void 0;
...
/*#__PURE__*/
function () {
  function AsyncWorker(workerPath) {
  ...
  _createClass(AsyncWorker, [{
    ...
    value: function post(params) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.worker.postMessage(_objectSpread({
          token: token
        }, params));
        ...
        var handleMessage = function handleMessage(_ref) {
          ...
          if (data.token === token) {
            _this.worker.removeEventListener('message', handleMessage);

            _this.worker.removeEventListener('error', handleError);
        ...
        _this.worker.addEventListener('error', handleError);
      });
    }
  }]);
...
var workerMessageHandler = function workerMessageHandler(_ref2) {
  var actions = _ref2.actions,
      self = _ref2.self;

  var handleMessageAsync =
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(event) {
      var data, token, payload, action, result;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              data = event.data;
              token = data.token, payload = data.payload, action = data.action;
              ...
              _context.next = 5;
              return actions[action].call(_this2, payload);
            ...
            case 7:
              throw new Error("Action \"".concat(action, "\" not recognized"));
    ...
    return function handleMessageAsync(_x) {
...
},{"./utils":"lib/utils.js"}],"worker-module.js":[function(require,module,exports) {
"use strict";
...
var _asyncWorker = require("./lib/asyncWorker");

var worker = new _asyncWorker.AsyncWorker('/worker.js');
exports.worker = worker;
},{"./lib/asyncWorker":"lib/asyncWorker.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
require("./worker-module");

document.querySelectorAll('.toggle-btn').forEach(function (button) {
  button.addEventListener('click', function () {
    button.classList.toggle('active');
    var target = button.getAttribute('toggle-target');
...
document.querySelectorAll('#drawer__nav router-link').forEach(function (link) {
...
},{"./style.scss":"style.scss","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./routing-module":"routing-module.js","./worker-module":"worker-module.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
