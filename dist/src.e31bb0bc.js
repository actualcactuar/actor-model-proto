...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/core-js/modules/_global.js":[function(require,module,exports) {
...
function () {
          ...
          case 0:
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              ...
              worker.addEventListener('error', function (error) {
                return reject(_objectSpread({}, error));
              });
            }));
  ...
  return function promiseMessage(_x) {
...
document.querySelector('#btn').addEventListener('click', function (e) {
  promiseMessage({
    ...
    var data = _ref3.data;
    return console.log(data, 'resolved');
  }).catch(function (e) {
    return console.log(e);
  });
});
},{"./style.scss":"style.scss","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
